...
const nodes = [
    ...
    { id: 'N', x: 670, y: 400, name: 'short-cut1' },
    { id: 'O', x: 670, y: 600, name: 'short-cut2' },
    { id: 'P', x: 550, y: 765, name: 'short-cut3' },
    { id: 'Q', x: 850, y: 765, name: 'short-cut4' },
    { id: 'R', x: 670, y: 60, name: 'short-cut5' },
    // ...更多节点
];
